...
function BorrowSchedulePage() {
  ...
  const handleConfirmBorrow = async () => {
    ...
    try {
      ...
      // Each borrowBook call will create a loan with status='pending' (chờ lấy sách)
      for (const book of cartItems) {
        await bookService.borrowBook(book._id, daysToBorrow);
      }

      alert(`✅ Đặt ${cartItems.length} cuốn sách thành công!\nLên thư viện: ${pickupDate} lúc ${pickupTime}\nNgày trả: ${returnDate}\n\nTrạng thái: Chờ Lấy Sách\nAdmin sẽ xác nhận khi bạn lên lấy.`);
